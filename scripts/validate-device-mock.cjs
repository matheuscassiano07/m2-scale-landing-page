...
assert(
  api.isMockInView({ top: 80, bottom: 680, height: 600, left: 0, right: 300, width: 300, x: 0, y: 80 }, 700),
  'topo do iPhone visível deve disparar animação'
);

assert(
  !api.isMockInView({ top: -520, bottom: 40, height: 560, left: 0, right: 300, width: 300, x: 0, y: -520 }, 700),
  'quase todo fora do viewport não deve disparar'
);
