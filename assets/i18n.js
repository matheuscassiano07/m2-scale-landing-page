  ...
  var STRINGS = {
    'pt-BR': {
      ...
      johnChat: {
        ...
        inputAria: 'Sua mensagem para o John AI',
      ...
      adminPage: {
        ...
        brand: 'Cantevo',
        dashboardTitle: 'Painel Cantevo',
        pageTitle: 'Leads',
        pageSubtitle: 'Leads do formulário e dúvidas do chat John AI',
        tabLeads: 'Leads',
        tabInquiries: 'Dúvidas John AI',
        inqPageSubtitle: 'Perguntas enviadas no chat da landing',
        inqStatTotal: 'Dúvidas',
        inqStatToday: 'Hoje',
        inqStatWeek: '7 dias',
        inqStatApi: 'Com IA',
        inqSearchPlaceholder: 'Buscar na pergunta ou resposta…',
        inqEmptyTitle: 'Nenhuma dúvida ainda',
        inqEmptyDesc:
          'Quando visitantes conversarem com o John AI na landing, as perguntas e respostas aparecem aqui.',
        inqColKind: 'Tipo',
        inqColQuestion: 'Pergunta',
        inqColReply: 'Resposta John AI',
        inqColSource: 'Origem',
        exportInqCsv: 'CSV dúvidas',
        inqKindAnswer: 'Resposta',
        inqKindOffTopic: 'Fora do escopo',
        inqKindHandoff: 'Encaminhou',
        inqKindGreet: 'Saudação',
        inqKindFallback: 'Sem API',
        inqSourceDevice: 'Mock celular',
        inqSourceFloat: 'Botão flutuante',
        inqSourceOther: 'Chat',
        inqTokensYes: 'IA',
        inqTokensNo: 'Fixa',
        statTotal: 'Total',
    ...
    en: {
      ...
      johnChat: {
        ...
        inputAria: 'Your message to John AI',
      ...
      adminPage: {
        ...
        brand: 'Cantevo',
        dashboardTitle: 'Cantevo dashboard',
        pageTitle: 'Leads',
        pageSubtitle: 'Form leads and John AI chat questions',
        tabLeads: 'Leads',
        tabInquiries: 'John AI questions',
        inqPageSubtitle: 'Questions from the landing chat',
        inqStatTotal: 'Questions',
        inqStatToday: 'Today',
        inqStatWeek: '7 days',
        inqStatApi: 'AI replies',
        inqSearchPlaceholder: 'Search question or reply…',
        inqEmptyTitle: 'No questions yet',
        inqEmptyDesc:
          'When visitors chat with John AI on the landing, questions and replies show up here.',
        inqColKind: 'Type',
        inqColQuestion: 'Question',
        inqColReply: 'John AI reply',
        inqColSource: 'Source',
        exportInqCsv: 'Export questions CSV',
        inqKindAnswer: 'Answer',
        inqKindOffTopic: 'Off-topic',
        inqKindHandoff: 'Handoff',
        inqKindGreet: 'Greeting',
        inqKindFallback: 'No API',
        inqSourceDevice: 'Phone mock',
        inqSourceFloat: 'Floating button',
        inqSourceOther: 'Chat',
        inqTokensYes: 'AI',
        inqTokensNo: 'Fixed',
        statTotal: 'Total',
